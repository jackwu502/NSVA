...
def get_args(description='UniVL on Caption Task'):
    ...
    parser.add_argument('--train_csv', type=str, default='/media/chris/hdd1/UniVL_processing_code/ourds_data_timesformer/ourds_train.44k.csv', help='')
    parser.add_argument('--val_csv', type=str, default='/media/chris/hdd1/UniVL_processing_code/ourds_data_timesformer/ourds_JSFUSION_test.csv', help='')
    parser.add_argument('--data_path', type=str, default='/media/chris/hdd1/UniVL_processing_code/ourds_data_timesformer/ourds_description.json',
                        help='caption and transcription pickle file path')
    parser.add_argument('--features_path', type=str, default='/media/chris/hdd1/UniVL_processing_code/ourds_data_timesformer/ourds_videos_features.pickle',
                        help='feature path for 2D features')

    # parser.add_argument('--train_csv', type=str, default='/media/chris/hdd1/UniVL_processing_code/ourds_data/ourds_train.44k.csv', help='')
    # parser.add_argument('--val_csv', type=str, default='/media/chris/hdd1/UniVL_processing_code/ourds_data/ourds_JSFUSION_test.csv', help='')
    # parser.add_argument('--data_path', type=str, default='/media/chris/hdd1/UniVL_processing_code/ourds_data/ourds_description.json',
    #                     help='caption and transcription pickle file path')
    # parser.add_argument('--features_path', type=str, default='/media/chris/hdd1/UniVL_processing_code/ourds_data/ourds_videos_features.pickle',
    #                     help='feature path for 2D features')

    parser.add_argument('--bbx_features_path', type=str, default='/media/chris/hdd1/UniVL_processing_code/ourds_bbx_data/ourds_videos_features.pickle',
                        help='feature path for 2D features')
...
def eval_epoch(args, model, test_dataloader, tokenizer, device, n_gpu, nlgEvalObj=None, test_set=None):
    ...
    for b_id, batch in enumerate(test_dataloader):
        ...
        with torch.no_grad():
            ...
            bbx_output = model.get_bbx_output(bbx.reshape(bbx.shape[0],bbx.shape[-2],bbx.shape[-1]), bbx_mask.reshape(bbx_mask.shape[0],bbx_mask.shape[-1]))
            ...
            bbz_mask_rpt = bbx_mask.repeat(1, n_bm).view(n_inst * n_bm, len_v)
            ...
            for len_dec_seq in range(1, args.max_words + 1):
                active_inst_idx_list = beam_decode_step(decoder, inst_dec_beams,
                                                        ...
                                                        (sequence_output_rpt, visual_output_rpt, input_ids_rpt, input_mask_rpt, video_mask_rpt, bbx_output_rpt, bbz_mask_rpt), task_type = task_type_rpt)

                if not active_inst_idx_list:
                    break  # all instances have finished their path to <EOS>

                (sequence_output_rpt, visual_output_rpt, input_ids_rpt, input_mask_rpt, video_mask_rpt,task_type_rpt), \
                inst_idx_to_position_map = collate_active_info((sequence_output_rpt, visual_output_rpt, input_ids_rpt, input_mask_rpt, video_mask_rpt,task_type_rpt),
...
action_list = json.load(open('/home/ubuntu/vcap/content/UniVL-main/action_list.json', 'r'))
